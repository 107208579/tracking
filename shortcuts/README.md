...
| Other                                                                                   | Action |
|:-                                                                                       |:-      |
|[Connect](https://www.icloud.com/shortcuts/12d8c5ecfdc14a82b01cf76987f53cb9)             |Connects the last two events of a selected calendar by setting the end time of the first event to the start time of the second event. This is useful when traveling where for example a walk followed by a bus ride and another walk need to be connected events. |
